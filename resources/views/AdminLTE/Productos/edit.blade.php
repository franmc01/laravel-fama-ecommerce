          ...
          <div class="col-md-6">
                  <div class="card card-outline card-gray">
                      <div class="card-body">
                              ...
                              <input type="text"
                                  class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="" value="{{ old('nombre',$editado->nombre_producto)}}" placeholder="Ingrese el nombre del producto">
                                  @error('nombre')
                              ...
                              <input type="text"
                                  class="form-control @error('codigo') is-invalid @enderror" name="codigo" id="" value="{{ old('codigo',$editado->codigo_unico) }}" placeholder="Ingrese el código del producto">
                                  @error('codigo')
                                  <small id="helpId" class="text-muted"><strong class="text-danger">{{ $message }}</strong></small>
                                  @enderror
                              </div>
                              ...
                              <textarea type="text" rows="8" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" id=""  placeholder="Ingrese la descripción">{{ old('descripcion', $editado->descripcion) }}</textarea>
                              @error('descripcion')
                              <small id="helpId" class="text-muted"><strong class="text-danger">{{ $message }}</strong></small>
                              @enderror
                              </div>
